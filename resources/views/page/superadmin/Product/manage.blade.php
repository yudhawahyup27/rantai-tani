        ...
        <div class="card-body">
            <form action="{{ isset($data->id) ? route('admin.product.update', $data->id) : route('admin.product.store') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="price" placeholder="Harga Beli"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="laba" id="laba"
                           class="form-control @error('laba') is-invalid @enderror"
                           value="{{ old('laba', $data->laba ?? '') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="price_sell" placeholder="Harga Jual"
                           class="form-control @error('price_sell') is-invalid @enderror"
                           value="{{ old('price_sell', $data->price_sell ?? '') }}" readonly required>
